...
<html lang="es">
    <head>
        ...
        <title>VB Panel - @yield('title')</title>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto ">
                            @auth
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{url('admin/noticias')}}">Noticias</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{url('admin/productos')
                                }}">Productos</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{url('admin/usuarios')
                                }}">Usuarios</a></li>
                                ...
                                <li>
                                    <form class="dropdown-item" action="{{ route('logout') }}" method="post">
                                        @csrf
                                        <button type="submit" class="cerrarSesion mt-1"> Cerrar Sesion  ({{auth()->user()->name}})  </button>
                                    </form>
                                </li>
                            @endauth
                            @guest
